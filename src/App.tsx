                    ...
                    <table className="w-full border-separate border-spacing-0 text-xs text-left">
                      <thead className="sticky top-0 z-40">
                        ...
                        <tr className="border-none" style={{ border: 'none' }}>
                          ...
                          <th colSpan={3} className="font-semibold text-xs tracking-wider text-brand-blue text-center bg-brand-yellow sticky z-30 h-7 py-0" style={{ top: '28px', verticalAlign: 'middle', lineHeight: 'normal', border: 'none' }}>
