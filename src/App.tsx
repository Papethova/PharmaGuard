                    ...
                    <table className="w-full border-separate border-spacing-0 text-xs text-left">
                      <thead className="sticky top-0 z-40">
                        <tr className="border-none" style={{ border: 'none' }}>
                          ...
                          <th rowSpan={2} className="font-semibold text-xs tracking-wider text-brand-blue text-center bg-brand-yellow sticky top-0 z-42 h-14 py-0" style={{ top: 0, verticalAlign: 'middle', lineHeight: 'normal', border: 'none' }}>
                            <div className="flex flex-col items-center justify-center">
                          ...
                          <th rowSpan={2} className="font-semibold text-xs tracking-wider text-white text-center w-[110px] bg-brand-blue border-b border-brand-blue/10 sticky top-0 z-30 h-14 py-0" style={{ top: 0, verticalAlign: 'middle', lineHeight: 'normal' }}>
                            <div className="flex flex-col items-center justify-center">
                              <span>Physical</span>
                              <span>Count</span>
                            </div>
