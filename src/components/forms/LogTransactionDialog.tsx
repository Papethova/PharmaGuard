        ...
        <ScrollArea className="flex-1 overflow-y-auto">
          <div className="p-5 pt-3 space-y-4">
            <div className="grid gap-1.5">
              <Label className="text-brand-dark-grey text-xs">Medication Search</Label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-1.5">
                <Label className="text-brand-dark-grey text-xs">Reference #</Label>
                <Input 
              ...
              <div className="grid gap-1.5">
                <Label className="text-brand-dark-grey text-xs">Quantity</Label>
                <Input 
                  type="number" 
                  value={quantity} 
            ...
            <div className="grid gap-1.5">
              ...
              <Select value={selectedUser} onValueChange={setSelectedUser}>
                <SelectTrigger className={`bg-brand-surface border-brand-blue/10 h-10 text-sm font-normal ${!selectedUser ? 'text-muted-foreground/50' : 'text-brand-dark-grey'}`}>
            ...
            <div className="grid gap-1.5">
              <Label className="text-brand-dark-grey text-xs">Notes</Label>
              <Input 
                value={reason} 
