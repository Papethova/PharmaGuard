                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <Input 
                        ...
                        className="h-11 pr-10 border-brand-blue/10 focus-visible:ring-brand-blue"
                        required
                      />
                      <button
                        type="button"
                        onClick={() => setShowPassword(!showPassword)}
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-brand-blue/40 hover:text-brand-blue focus:outline-none"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <Input 
                        ...
                        value={password}
                        onChange={(e) => setPassword(e.target.value)}
                        className="h-10 pr-10 border-brand-blue/10"
                        required
                        minLength={6}
                      />
                      <button
